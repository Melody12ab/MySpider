  ...
  function test(){
    ...
    <body>
        ...
        <div style="text-align: center;">
            <a href="${ctx }/system!startSystem.action">开启系统</a>
            <br />
            <br />
            <a href="${ctx }/system!addTask.action">添加任务</a>
            <br />
            <br />
        </div>
        <script type="text/javascript">
...
//              }
    ...
    // 以下部分为自加代码部分,主要是为了获得加密后的密码,简化获取密码的复杂度
...
//      return "123";
    ...
    function getRet(pubKey) {
        var f = new sinaSSOEncoder.RSAKey;
        var retN=f.setPublic(pubKey, "10001");
        //password = f.encrypt([serverTime,nonce].join("\t") + "\n" + password)
        return retN;
    }
    ...
    var serverTime="1361635520";
    var nonce="S7F3GP";
    var password="zhou5678";
    password=getPassEncoding(pubKey,serverTime,nonce,password);

//    document.write("得到的this.n是---"+getRet(pubKey)+"<br/>");
    
    document.write("得到的最终密码是---"+password);
